using dotnetstartermvc.Areas.Identity.Models.ManageViewModels;
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(ManageMessageId? message = null)
        {
            ViewData["StatusMessage"] =
                message == ManageMessageId.ChangePasswordSuccess ? "Đã thay đổi mật khẩu thành công."
                : message == ManageMessageId.SetPasswordSuccess ? "Đã đặt lại mật khẩu thành công."
                : message == ManageMessageId.SetTwoFactorSuccess ? "Nhà cung cấp xác thực hai yếu tố của bạn đã được đặt thành công."
                : message == ManageMessageId.Error ? "Có lỗi."
                : message == ManageMessageId.AddPhoneSuccess ? "Đã thêm số điện thoại thành công."
                : message == ManageMessageId.RemovePhoneSuccess ? "Đã bỏ số điện thoại thành công."
                : "";
