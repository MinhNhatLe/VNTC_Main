using dotnetstartermvc.Areas.Identity.Models.AccountViewModels;
using dotnetstartermvc.ExtendMethods;
using dotnetstartermvc.Models;
using dotnetstartermvc.Utilities;
...
namespace dotnetstartermvc.Areas.Identity.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(model.Email,
                        ...
                        @$"Bạn đã đăng ký thành công tài khoản trên VNTC, 
        ...
        public async Task<IActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            var message = "Mã bảo mật của bạn là: " + code;
            if (model.SelectedProvider == "Email")
            {
                await _emailSender.SendEmailAsync(await _userManager.GetEmailAsync(user), "Mã bảo mật", message);
            }
